...
namespace B2b.Web.Controllers.Api
{
    ...
    public class ExchangeApiController : ControllerBase
    {
        ...
        public ExchangeApiController(IExchangeService service)
        {
            _service = service;
        }
        [HttpGet]
        ...
        [HttpPost]
        public IActionResult Add(Exchange data)
        {
        ...
        [HttpPut]
        public IActionResult Update(Exchange data)
        {
            return Ok(_service.Update(data));
        }
        [HttpGet]
        public IActionResult AutoUpdate()
        {
            return Ok(_service.AutoUpdate());
        }
    }
}
