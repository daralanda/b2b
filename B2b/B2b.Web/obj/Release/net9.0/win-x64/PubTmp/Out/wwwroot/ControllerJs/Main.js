    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response.List.length ==0) {
                tab.innerHTML += `<a class="nav-link active" id="0-tab" data-bs-toggle="pill" href="#0" role="tab" aria-controls="0" aria-selected="false" tabindex="-1">
                                                    <img src="/uploads/default.jpg" alt="" class="img-fluid mx-auto d-block rounded">
                                                </a>`;
                tabContent.innerHTML += `  <div class="tab-pane fade  show active" id="0" role="tabpanel" aria-labelledby="0-tab">
                                                    <div>
                                                        <img src="/uploads/default.jpg" alt="" class="img-fluid mx-auto d-block">
                                                    </div>
                                                </div>`;
            }
