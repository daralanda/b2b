!function (s) {
    "use strict";
    var e, t = localStorage.getItem("language"), a = "en";
    function n(e) {
    ...
    function c(e) {
        1 == s("#light-mode-switch").prop("checked") && "light-mode-switch" === e ? (s("html").removeAttr("dir"),
            ...
            sessionStorage.setItem("is_visited", "light-mode-switch")) : 1 == s("#dark-mode-switch").prop("checked") && "dark-mode-switch" === e ? (s("html").removeAttr("dir"),
                ...
                "assets/css/bootstrap.min.css" != s("#bootstrap-style").attr("href") && s("#bootstrap-style").attr("href", "assets/css/bootstrap.min.css"),
                "assets/css/app.min.css" != s("#app-style").attr("href") && s("#app-style").attr("href", "assets/css/app.min.css"),
                sessionStorage.setItem("is_visited", "dark-mode-switch")) : 1 == s("#rtl-mode-switch").prop("checked") && "rtl-mode-switch" === e ? (s("#light-mode-switch").prop("checked", !1),
                    s("#dark-mode-switch").prop("checked", !1),
                    s("#dark-rtl-mode-switch").prop("checked", !1),
                    ...
                    s("html").attr("dir", "rtl"),
                    s("html").attr("data-bs-theme", "light"),
                    sessionStorage.setItem("is_visited", "rtl-mode-switch")) : 1 == s("#dark-rtl-mode-switch").prop("checked") && "dark-rtl-mode-switch" === e && (s("#light-mode-switch").prop("checked", !1),
                        s("#rtl-mode-switch").prop("checked", !1),
                        s("#dark-mode-switch").prop("checked", !1),
                        "assets/css/bootstrap-rtl.min.css" != s("#bootstrap-style").attr("href") && s("#bootstrap-style").attr("href", "assets/css/bootstrap-rtl.min.css"),
                        "assets/css/app-rtl.min.css" != s("#app-style").attr("href") && s("#app-style").attr("href", "assets/css/app-rtl.min.css"),
    ...
    s("#side-menu").metisMenu(),
        ...
        window.sessionStorage && ((e = sessionStorage.getItem("is_visited")) ? (s(".right-bar input:checkbox").prop("checked", !1),
            s("#" + e).prop("checked", !0)) : "rtl" === s("html").attr("dir") && "dark" === s("html").attr("data-bs-theme") ? (s("#dark-rtl-mode-switch").prop("checked", !0),
                s("#light-mode-switch").prop("checked", !1),
                sessionStorage.setItem("is_visited", "dark-rtl-mode-switch"),
                c(e)) : "rtl" === s("html").attr("dir") ? (s("#rtl-mode-switch").prop("checked", !0),
                    s("#light-mode-switch").prop("checked", !1),
                    sessionStorage.setItem("is_visited", "rtl-mode-switch"),
                    c(e)) : "dark" === s("html").attr("data-bs-theme") ? (s("#dark-mode-switch").prop("checked", !0),
                        s("#light-mode-switch").prop("checked", !1),
                        sessionStorage.setItem("is_visited", "dark-mode-switch"),
                        c(e)) : sessionStorage.setItem("is_visited", "light-mode-switch")),
